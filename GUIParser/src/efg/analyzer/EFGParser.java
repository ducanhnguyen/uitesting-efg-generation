...
import guitree.object.EfgEventGraph;
import guitree.object.EfgEvents;
import guitree.object.EfgNode;
import guitree.object.EfgUnknownNode;
...
import guitree.object.Property;
import utils.Search;
import utils.SimpleTreeDisplayer;
import utils.condition.EventNodeCondition;

/**
 * Parse EFG output by GUITAR to construct EFG tree. This tree will be used in
 * other processes.
 * 
 * @author ducanhnguyen
 */
public class EFGParser {
	...
	public static void main(String[] args) {
		EFGParser parser = new EFGParser("./sample/Project.EFG.xml");
		parser.parseEfgTree();
		System.out.println("EFG NODES:" + new SimpleTreeDisplayer(parser.getRoot()).getTreeInString());
		System.out
				.println("DEPENDENCIES BETWEEN EVENTS MATRIX:\n" + parser.getEventMatrix().exportEventMatrixToString());
	}
